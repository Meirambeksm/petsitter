...
export default function Testing({ personalData }) {
  ...
  function handleAnswer() {
    ...
    result.push(answer);
    if (counter >= questions.length - 1) sendData();
    setAnswer(null);
  }
...
/*
END BUTTON: 
3) Timer deadline stops the test and sends the existing result + n/a to the server and go to video section
*/

/*
Refactoring tomorrow
Remove files tomorrow
*/
